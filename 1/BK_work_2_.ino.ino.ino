...
int off = 20000; //вермя отключения экрана до 32 767
...
if(digitalRead(2)==LOW&&flag==1)//если кнопка нажата     // и перемення flag равна 0 , то ...
       {   
               // digitalWrite(13,LOW);
         flag=0;
         }
...
if(digitalRead(2)==HIGH)   
    ...
    if(digitalRead(2)==LOW)//если кнопка нажата     // и перемення flag равна 0 , то ...
       {           
         lcd.setCursor(0, 0);
  lcd.write(32);
               }
